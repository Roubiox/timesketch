...
class UserSettingsResource(resources.ResourceMixin, Resource):
    ...
    def get(self):
        ...
        # If the value of SEARCH_PROCESSING_TIMELINES changes to false while the user had the option enabled,
        # it remains enabled without functioning. Therefore, if SEARCH_PROCESSING_TIMELINES changes to false,
        # we disable the showProcessingTimelineEvents option in the user's settings for display consistency.
